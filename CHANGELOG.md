...
### Deprecated
- quant-dashboard superseded by quant-openbb as the primary UI layer for the
  quant trading system. This release is the final feature-complete snapshot.
  The container remains operational. No new features will be added.
  Migration guide: https://github.com/lumduan/quant-openbb#migration-from-quant-dashboard
