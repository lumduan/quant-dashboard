...
const strategyReportResponse: StrategyReportResponse = {
  ...
  report: {
    ...
    capital_efficiency: {
      capital_usage: {
        all: {
          annualized_return_cagr: 0.15,
          return_on_initial_capital: 0.125,
          account_size_required: 250000,
          return_on_account_size_required: 0.1,
          net_profit_pct_of_largest_loss: 0.08,
        },
        long: {
          annualized_return_cagr: 0.12,
          return_on_initial_capital: 0.09,
          account_size_required: 250000,
          return_on_account_size_required: 0.072,
          net_profit_pct_of_largest_loss: 0.06,
        },
        short: {
          annualized_return_cagr: 0.18,
          return_on_initial_capital: 0.035,
          account_size_required: 250000,
          return_on_account_size_required: 0.028,
    ...
    runups_drawdowns: {
      runups: {
        ...
        avg_runup: 0.035,
        max_runup_close_to_close: 32000,
        max_runup_intrabar: null,
        max_runup_pct_initial_capital_intrabar: null,
      },
      drawdowns: {
        avg_duration_days: 8,
        avg_drawdown: -0.025,
        max_drawdown_close_to_close: -15000,
        max_drawdown_intrabar: null,
        max_drawdown_pct_initial_capital_intrabar: null,
